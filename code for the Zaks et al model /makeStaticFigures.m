...
function makeStaticFigures( samplepam)
...
makefigurecompare(2, 'pHLumen',idxhigh,  [ 0.7 0.25 0.01 0.01],'Lumen pH')
ylabel('Lumen pH')
xlim([0 1500])
makefigurecompare(9, 'pmf',idxhigh,  [ 0.7 0.7 0.01 0.01],'pmf')
xlim([0 1500])

makefigurecompare(10, 'pmf',1,  [ 0.7 0.7 0.01 0.01],'`pmf')
xlim([0 1500])

makefigurecompare(1, 'pHLumen',1,  [ 0.7 0.25 0.01 0.01],  'Lumen pH')
xlim([0 1500])
