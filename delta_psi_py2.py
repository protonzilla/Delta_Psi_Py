...
import generate_light_profiles as glp
...
def dark_equibration(y_initial, Kx, total_duration, **keyword_parameters): 
    ...
    points_per_second=10
    max_PAR=0
    dark_time_light_profile = glp.generate_sin_wave(total_duration, max_PAR, light_frequency, points_per_second)
    max_light_change=10
    points_per_segment=100
...
envelope=glp.sin_light(day_length, max_PAR, 10) #make an envelope shaped like a sin wave
...
light_array=glp.generate_light_profile(envelope, fluctuations) # Put is all together to generate the light profile
...
light_array_1=glp.generate_light_profile(envelope, fluctuations) #make the array of time and light values
...
light_array_2=glp.generate_light_profile(envelope, fluctuations)
...
light_array_3=glp.generate_light_profile(envelope, fluctuations)
